package org.litespring.service.annotation;
...
public class MyAnnotationTest {
    ...
    public static void main(String[] args) {
        ...
        if(MyAnnotationTest.class.isAnnotationPresent(MyAnnotation.class)) {
            ...
            System.out.println(annotation.value());//输出value属性的默认值：qingge
            ...
            System.out.println(annotation.annotationAttr().value());//这里输出的注解属性值:abc

            MetaAnnotation ma = annotation.annotationAttr();//annotation是MyAnnotation类的一个实例对象
            System.out.println(ma.value());//输出的结果为：abc
