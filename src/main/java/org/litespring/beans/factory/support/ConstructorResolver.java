...
public class ConstructorResolver {
    ...
    public Object autowireConstructor(final BeanDefinition bd) throws BeanCreationException {
        ...
        if(constructorToUse == null){
            throw new BeanCreationException(bd.getID() + "Instantiation of bean failed, can't resolve class, can't find a apporiate constructor");
        }

        try {
            return constructorToUse.newInstance(argsToUse);
        } catch (Exception e) {
            throw new BeanCreationException(bd.getID(), "Instantiation of bean failed, can't resolve class, can't find a create instance using "+constructorToUse, e);
        }
